...
public class ParseScriptPresenter implements ParseScriptContract.ActionsListener {

    private final ParseScriptContract.View mView;
    ...
    public ParseScriptPresenter(ParseScriptContract.View view, ScriptRepository model ) {
        mView = view;
        mModel = model;
    ...
    private ScriptRepository.ParseScriptCallback onAddScriptCallback( final boolean bNewQuizFolder,
        ...
        return new ScriptRepository.ParseScriptCallback(){
            ...
            public void onSuccess( Script script ) {
                Log.i("AppContent", "addPDFScript onSuccess()  user: " + msgForLog);
            ...
            @Override
            public void onFail(EResultCode resultCode) {
                Log.e("AppContent", "addPDFScript onFail() UnkownERROR. " +
    ...
    private void addQuizFolder( String quizFolderName, String scriptName ) {
        Log.i("AppContent", "ParseScriptPresenter addScriptIntoQuizFolder() called");
