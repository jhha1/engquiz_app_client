...
public class QuizFolderScriptsAdapter extends BaseAdapter {
    ...
    public QuizFolderScriptsAdapter(ScriptRepository scriptRepository,
   ...
   */
    ...
    private List<ScriptSummary> convertFormat(Integer quizFolderID, List<Integer> quizFolderScriptIds)
    {
        ...
        for(Integer id: quizFolderScriptIds){
            String title = mScriptModel.getScriptTitleById(id);
