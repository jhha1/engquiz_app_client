...
public class AddQuizFolderDetailPresenter implements AddQuizFolderDetailContract.ActionsListener {
    ...
    public AddQuizFolderDetailPresenter(AddQuizFolderDetailContract.View view, QuizFolderRepository model ) {
        mModel = model;
        mView = view;
    }
    ...
    public void addScriptIntoQuizFolder(Integer quizFolderId, String scriptTitle ) {
        Log.i("AppContent", "AddQuizFolderDetailPresenter addScriptIntoQuizFolder() called. quizFolderId:"+quizFolderId);
        final ScriptRepository scriptRepo = ScriptRepository.getInstance();
