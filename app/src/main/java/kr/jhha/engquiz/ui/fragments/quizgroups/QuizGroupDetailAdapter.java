...
public class QuizGroupDetailAdapter extends BaseAdapter
{
    ...
    private QuizGroupItem mCurrentQuizGroup = null;
    ...
    @Override
    public int getCount() {
        return mCurrentQuizGroup.getScriptIndexes().size();
    }
    ...
    public void setCurrentQuizGroup( QuizGroupItem quizGroup )
    {
        String quizGroupTitle = quizGroup.getTitle();
        if( Utils.isNullString(quizGroupTitle) ) {
        ...
        if( false == mQuizGroupDetailIMap.containsKey( quizGroupTitle ) ) {
            ...
            Log.d("%%%%%%%%%%%%%%%", "detailadapter. setCurrentQuizGroup. " +
                    "quizGroup.getScriptIndexes().size():" + quizGroup.getScriptIndexes().size());
            for( Integer index : quizGroup.getScriptIndexes() ) {
